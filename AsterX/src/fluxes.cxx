...
extern "C" void AsterX_Fluxes(CCTK_ARGUMENTS) {
  ...
  case eos_t::IdealGas: {
    ...
    CalcFlux<0>(cctkGH, eos_ig.data()[0]);
    CalcFlux<1>(cctkGH, eos_ig.data()[0]);
    CalcFlux<2>(cctkGH, eos_ig.data()[0]);
    break;
  }
  case eos_t::Hybrid: {
  ...
  case eos_t::Tabulated: {
    ...
    CalcFlux<0>(cctkGH, eos_tab3d.data()[0]);
    CalcFlux<1>(cctkGH, eos_tab3d.data()[0]);
    CalcFlux<2>(cctkGH, eos_tab3d.data()[0]);
    break;
  }
  default:
    assert(0);
